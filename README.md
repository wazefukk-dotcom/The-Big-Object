...
* No needlessly large string literals or static arrays, keep those to a minimum. All bloat should be intentional instead of just "haha look at that 3 billion member array" 
